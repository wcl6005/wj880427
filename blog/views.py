...
import xlsxwriter
import json
#from myAPI.myFile import readJson 
...
def billing(request, page):
    ...
    if request.user in operators:
        #company_name_list = ''#readJson('static_common/sortTXT/companynamelist.txt')
...
def addBilling(request):
    ...
    #cleanData = request.POST.items() #POST对象直接转为元组
